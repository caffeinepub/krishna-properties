...
export class Backend implements backendInterface {
    ...
    async addQuery(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addQuery(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllQueries(): Promise<Array<CustomerQuery>> {
        if (this.processError) {
            try {
    ...
    async getQueryCountByStatus(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQueryCountByStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateQueryStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
